...
import numpy as np
import unittest
from FuN.scripts.training.feudal_networks.policies.feudal_batch_processor import FeudalBatchProcessor, FeudalBatch
...
#        np.testing.assert_array_equal(fb.features, [4,5])  # Error occurred here also (features again)
...
#        np.testing.assert_array_equal(fb.features, [1,2])  # Error occurred here
...
#        np.testing.assert_array_equal(fb.features, [3,4,5])  # Error occurred here
