...
def design_agent_and_env(FLAGS):
    ...
    # Enter max number of atomic actions.  This will typically be FLAGS.time_
    # scale**(FLAGS.layers).  However, in the UR5 Reacher task, we use a
    ...
    agent_params = {
        ...
        # atomic actions. Noise added is Gaussian N(0, noise_percentage *
        # action_dim_range)
